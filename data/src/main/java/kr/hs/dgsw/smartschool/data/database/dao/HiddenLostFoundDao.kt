...
interface HiddenLostFoundDao : BaseDao<HiddenLostFoundEntity> {
    ...
    @Query("INSERT INTO hidden_lost_found_table(idx,memberId, title, place, content, contact) VALUES(:entity)")
    override suspend fun insert(entity : HiddenLostFoundEntity)
